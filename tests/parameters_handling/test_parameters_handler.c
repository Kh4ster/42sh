...
Test(arguments, no_arg)
{
    ...
    char *argv[] = {"42sh"};
    cr_assert_eq(0, handle_parameters(&options, 1, argv), "return val should be 1");
...
Test(arguments, arg_minus_o)
{
    ...
    cr_assert_eq(0, handle_parameters(&options, 2, argv), "return val should be 1");
    cr_assert_eq(0, options.option_c, "should be 0");
    cr_assert_eq(0, options.option_n, "should be 0");
    cr_assert_eq(0, options.option_a, "should be 0");
    cr_assert_null(options.command_option_c, "should be null");
...
Test(arguments, arg_c)
{
    struct boot_params options = {0};
    char *argv[] = {"42sh", "-c", "ls"};
    cr_assert_eq(0, handle_parameters(&options, 3, argv), "return val should be 1");
...
Test(arguments, arg_mix)
{
    ...
    cr_assert_eq(0, handle_parameters(&options, 4, argv), "return val should be 1");
    cr_assert_eq(1, options.option_c, "should be 1");
    cr_assert_eq(0, options.option_n, "should be 0");
...
Test(arguments, error_bad_param)
{
    struct boot_params options = {0};
    char *argv[] = {"42sh", "-t"};
    cr_assert_eq(2, handle_parameters(&options, 2, argv), "return val should be -1");
    cr_assert_eq(0, options.option_c, "should be 0");
    cr_assert_eq(0, options.option_n, "should be 0");
    cr_assert_eq(0, options.option_a, "should be 0");
    cr_assert_null(options.command_option_c, "should be null");
...
Test(arguments, error_file_not_exist)
{
    ...
    cr_assert_eq(127, handle_parameters(&options, 2, argv), "return val should be -1");
    cr_assert_eq(0, options.option_c, "should be 0");
    cr_assert_eq(0, options.option_n, "should be 0");
    cr_assert_eq(0, options.option_a, "should be 0");
    cr_assert_null(options.command_option_c, "should be null");
...
Test(arguments, option_pluso_bad_param)
{
    ...
    cr_assert_eq(2, handle_parameters(&options, 3, argv), "return val should be -1");
}
...
Test(arguments, option_minuso_good_param)
{
    ...
    cr_assert_eq(0, handle_parameters(&(g_env.options), 3, argv), "return val should be 1");
    cr_assert_eq(true, g_env.options.option_nocaseglob);
    optind = 1;
    char *argv2[] = {"42sh", "+O", "nocaseglob", NULL};
    cr_assert_eq(0, handle_parameters(&(g_env.options), 3, argv2), "return val should be 1");
    cr_assert_eq(false, g_env.options.option_nocaseglob);
}
...
Test(arguments, option_minuso_good_param_and_file)
{
    ...
    cr_assert_eq(false, g_env.options.option_nocaseglob);
    cr_assert_eq(0, handle_parameters(&(g_env.options), 4, argv), "return val should be 1");
    cr_assert_eq(true, g_env.options.option_nocaseglob);
}
...
Test(arguments, option_minuso_bad_param_and_file)
{
    ...
    cr_assert_eq(false, g_env.options.option_nocaseglob);
    cr_assert_eq(2, handle_parameters(&(g_env.options), 4, argv), "return val should be -1");
}
